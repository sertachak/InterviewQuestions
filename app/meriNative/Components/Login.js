...
const Login = props => {
  ...
  const [ startingText, setStartingText ] = useState("Login to use Recommendation");
            ...
            <ImageBackground source={require('./../resources/mainBackground.jpg')} style={{ width: '100%', height: '100%' }}>
                <View style={styles.mainView}>
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={styles.customBtnText}>Navigate</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={styles.customBtnBG}
                        onPress={() => props.navigation.navigate('Similar')  }>
                        <Text style={styles.customBtnText}>Similar</Text>
                    </TouchableOpacity>
                    </View>
                </View>
            </ImageBackground>
